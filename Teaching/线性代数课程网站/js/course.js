...
(function (course) {
  ...
  course.chapters[0].lessons = [
    ...
    { id: "chapter01-section02", number: "1.2", title: "向量线性相关性", description: "从线性组合与张成空间出发，理解向量组中方向是否冗余。", path: "chapters/chapter01/section02/index.html", readingPath: "chapters/chapter01/section02/index.html", legacyPath: "chapters/chapter01.html#vector-dependence", anchor: "vector-dependence", sourceRanges: [[1,2],[3,3],[4,4],[5,5],[6,8]], pages: [
    ...
    { id: "chapter01-section03", number: "1.3", title: "坐标系、坐标与坐标变换", description: "从仿射坐标系出发，理解向量坐标运算与基变换。", path: "chapters/chapter01/section03/index.html", readingPath: "chapters/chapter01/section03/index.html", legacyPath: "chapters/chapter01.html#coordinates", anchor: "coordinates", sourceRanges: [[1,2],[3,4],[5,5],[6,7],[8,9]], pages: [
    ...
    { id: "chapter01-section04", number: "1.4", title: "复数与数域", description: "从实数坐标推广到复数，认识复平面与数域。", path: "chapters/chapter01/section04/index.html", readingPath: "chapters/chapter01/section04/index.html", legacyPath: "chapters/chapter01.html#complex-and-fields", anchor: "complex-and-fields", sourceRanges: [[1,1],[2,2],[3,4],[5,6]], pages: [
    ...
    { id: "chapter01-section05", number: "1.5", title: "数组向量", description: "把三维几何向量推广为任意维数组，掌握分量运算与基本向量。", path: "chapters/chapter01/section05/index.html", readingPath: "chapters/chapter01/section05/index.html", legacyPath: "chapters/chapter01.html#array-vectors", anchor: "array-vectors", sourceRanges: [[1,1],[2,2],[3,3],[4,5],[6,6],[7,8]], pages: [
